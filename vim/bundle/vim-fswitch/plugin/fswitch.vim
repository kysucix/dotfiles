...
augroup fswitch_au_group
    au!
    au BufEnter *.h call s:SetVariables('cpp,c,cc,C', 'reg:/include/src/,reg:/include.*/src/,ifrel:|/include/|../src|')
    au BufEnter *.c,*.cpp,*.cc,*.C call s:SetVariables('h', 'reg:/src/include/,reg:|src|include/**|,ifrel:|/src/|../include|')
augroup END
